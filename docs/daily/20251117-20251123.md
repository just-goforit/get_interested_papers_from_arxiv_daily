...
- **[arXiv2511] D2D Power Allocation via Quantum Graph Neural Network**
  - **tags:** [mlsys], [Other models inference], [Quantum Graph Neural Network, D2D power allocation, Parameterized Quantum Circuits, SINR maximization, wireless optimization]
  - **authors:** Tung Giang Le, Xuan Tung Nguyen, Won-Joo Hwang
  - **institution:** Pusan National University, PHENIKAA University
  - **link:** https://arxiv.org/pdf/2511.15246v1
  - **Simple LLM Summary:** The paper proposes a fully quantum Graph Neural Network using Parameterized Quantum Circuits to implement message passing for D2D power control. The quantum GNN encodes features into quantum states and processes graphs with NISQ-compatible unitaries. Experimental results show the quantum GNN achieves competitive SINR maximization performance with fewer parameters and inherent parallelism compared to classical approaches.

- **[arXiv2511] Masked Auto-Regressive Variational Acceleration: Fast Inference Makes Practical Reinforcement Learning**
  - **tags:** [mlsys], [post-training], [masked auto-regressive diffusion, variational distillation, reinforcement learning, inference acceleration]
  - **authors:** Yuxuan Gu, Weimin Bai, Yifei Wang, Weijian Luo, He Sun
  - **institution:** Peking University, Rice University, Xiaohongshu Inc
  - **link:** https://arxiv.org/pdf/2511.15190v1
  - **Simple LLM Summary:** MARVAL introduces a score-based variational distillation framework that compresses masked auto-regressive diffusion models into single-step generation while preserving sample quality. This enables over 30x inference speedup and makes practical RL post-training possible. The method achieves state-of-the-art FID scores on ImageNet while improving preference alignment through MARVAL-RL.

- **[arXiv2511] Particle Monte Carlo methods for Lattice Field Theory**
  - **tags:** [mlsys], [Other models inference], [Monte Carlo methods, lattice field theory, GPU acceleration, neural samplers, sequential Monte Carlo, nested sampling, partition function estimation]
  - **authors:** David Yallup
  - **institution:** Kavli Institute for Cosmology Cambridge, University of Cambridge
  - **link:** https://arxiv.org/pdf/2511.15196v1
  - **Simple LLM Summary:** This paper demonstrates that GPU-accelerated particle methods, specifically Sequential Monte Carlo and nested sampling, provide competitive classical baselines for lattice field theory sampling. These methods match or outperform state-of-the-art neural samplers in both sample quality and computational efficiency on scalar field theory benchmarks. The approach achieves strong performance using minimal tuning while also estimating partition functions, raising the bar for justifying neural samplers' training costs.

- **[arXiv2511] GPU-Initiated Networking for NCCL**
  - **tags:** [mlsys], [Other models training], [GPU communication, NCCL Device API, GPU-Initiated Networking, Mixture-of-Experts, RDMA, low-latency communication]
  ...
  - **link:** https://arxiv.org/pdf/2511.15076v1
  - **Simple LLM Summary:** This paper introduces GPU-Initiated Networking (GIN) in NCCL 2.28, enabling direct GPU-to-GPU communication through a three-layer architecture with dual backend implementations. The method eliminates CPU coordination overhead and provides device-side control for remote memory operations. Results show GIN successfully integrates low-latency operations with NCCL's collective algorithms, particularly benefiting Mixture-of-Experts architectures.
